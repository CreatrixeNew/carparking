									...
									<div class="tab-pane active" id="C">
										<table class="data-tbl-simple table table-bordered">
											<tbody>
												...
												<tr>
													<td style="border-left: 4px solid skyblue;font-weight: bold"> Northern </td>
													<td> 4 Cars </td>
												</tr>
												<tr>
													<td style="border-left: 4px solid #faa732;font-weight: bold"> Southern </td>
													<td> 5 Cars </td>
												</tr>
											</tbody>
										</table>
					...
					<div class="widget-box">
						<div class="well white-box">
							<table class="data-tbl-simple table table-bordered">
								<tbody>
									<tr>
										<td style="border-left: 4px solid skyblue;font-weight: bold"> Northern Pick Up </td>
										<td> 4 Cars </td>
									</tr>
									<tr>
										<td style="border-left: 4px solid #faa732;font-weight: bold"> Southern Pick Up </td>
										<td> 5 Cars </td>
									</tr>
									<tr>
										<td style="border-left: 4px solid skyblue;font-weight: bold"> Northern Return </td>
										<td> 4 Cars </td>
									</tr>
									<tr>
										<td style="border-left: 4px solid #faa732;font-weight: bold"> Southern Return </td>
										<td> 5 Cars </td>
									</tr>
								</tbody>
							</table>
				...
				<div class="widget-content" style="overflow-y: scroll;height: 465px;">
					<div class="widget-box" style="height: 465px;">
						<div class="well white-box">
							...
							<div class="progress"> <span style="width: 20%;" title="20% of this Job has been done"><span>20%</span></span> </div>
							<h6>Job #1082 - Return Job  - Driver #103 - June 23rd, 2015</h6>
							<div class="progress"> <span class="green" title="40% of this Job has been done" style="width: 40%;"><span>40%</span></span> </div>
							<h6>Job #1672 -   Movement    - Driver #943 - June 12th, 2015</h6>
							<div class="progress"> <span class="orange" title="60% of this Job has been done" style="width: 60%;"><span>60%</span></span> </div>
							<h6>Job #1622 -   Movement    - Driver #113 - July 12th, 2015</h6>
							<div class="progress"> <span class="red" title="20% of this Job is remaining" style="width: 80%;"><span>80%</span></span> </div>
							<h6>Job #5624 -   Return Job    - Driver #763 - July 12th, 2015</h6>
							<div class="progress"> <span class="blue" title="This Job has been done" style="width: 100%;"><span>100%</span></span> </div>
							<h6>Job #5699 -   Movement Job    - Driver #823 - July 12th, 2015</h6>
							<div class="progress"> <span class="orange" title="This Job has been done" style="width: 60%;"><span>60%</span></span> </div>
							<h6>Job #5344 -   Pick Up Job    - Driver #713 - July 12th, 2015</h6>
							<div class="progress"> <span title="This Job has been done" style="width: 20%;"><span>20%</span></span> </div>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="widget-box">
						<div class="well white-box" style="height: 426px;">
							<div class="alert alert-error fade in">
								...
								<strong>JOB # 5690!</strong> Critical stage, it's not looking too good. </div>
							<div class="alert fade in">
								<button data-dismiss="alert" class="close" type="button">×</button>
								<strong>Driver: Jack!</strong> Free from last job, and now no job in queue. </div>
							<div class="alert alert-success fade in">
								<button data-dismiss="alert" class="close" type="button">×</button>
								<strong>JOB # 3217 !</strong> William has completed this job successfully. </div>
							<div class="alert alert-info fade in">
								<button data-dismiss="alert" class="close" type="button">×</button>
								<strong>New Job!</strong> This alert needs your attention, One upcoming job. </div>
							<div class="alert alert-error fade in">
								<button data-dismiss="alert" class="close" type="button">×</button>
								<strong>JOB # 5290!</strong> Critical stage, it's not looking too good. </div>
							<div class="alert alert-success fade in">
								<button data-dismiss="alert" class="close" type="button">×</button>
								<strong>JOB # 3117 !</strong> Mark has done this job. </div>
						</div>
					</div>
				</div>
			</div>
	...
	<div class="row-fluid">
		<div class="span3">
			<div class="dashboard-wid-wrap" style="background: none;border-radius: 0px;">
				<div class="dashboard-wid-content"> <a href="#" style="border-radius:0px; background: #F2A0A0;overflow: hidden;"> <span class="dashboard-icons-colors date_sl" style="float:left;"></span><font style="color:#ffffff;font-size: 24px;">1765</font>
					<h6 style="color:#ffffff;">Upcoming BOOKINGS: </h6>
					</a> </div>
			</div>
		</div>
		<div class="span3">
			<div class="dashboard-wid-wrap" style="background: none;border-radius: 0px;">
				<div class="dashboard-wid-content"> <a href="#" style="border-radius:0px; background: #A0D1F2;overflow: hidden;"><span class="dashboard-icons-colors shipping_sl" style="float:left;"></span><font style="color:#ffffff;font-size: 24px;">125</font>
					<h6 style="color:#ffffff;">TOTAL BOOKINGS: 1765</h6>
					</a> </div>
			</div>
		</div>
		<div class="span3">
			<div class="dashboard-wid-wrap" style="background: none;border-radius: 0px;">
				<div class="dashboard-wid-content"> <a href="#" style="border-radius:0px; background: #F2D4A0;overflow: hidden;"> <span class="dashboard-icons-colors free_for_job_sl" style="float:left;"></span> <font style="color:#ffffff;font-size: 24px;">1835</font>
					<h6 style="color:#ffffff;">Available Slots</h6>
					</a> </div>
			</div>
		</div>
		<div class="span3">
			<div class="dashboard-wid-wrap" style="background: none;border-radius: 0px;">
				<div class="dashboard-wid-content"> <a href="#" style="border-radius:0px; background: #AAD698;overflow: hidden;"> <span class="dashboard-icons-colors lightbulb_sl" style="float:left;"></span> <font style="color:#ffffff;font-size: 24px;">1325</font>
					<h6 style="color:#ffffff;">Mystery Bookings</h6>
					</a> </div>
			</div>
		</div>
	</div>
...
<div class="chatter">
	...
	<div class="chatter_post_signup">
		<div class="head">
			<h4 style=" margin-top: 3px;color:#3c8dbc;">Luke Peters</h4>
			<img class="cross" width="16" src="<?php echo base_url(); ?>assets/img/cross.png" /></div>
		<div class="chatter_convo"> <span class="chatter_msg_item chatter_msg_item_admin"> <a href="" class="chatter_avatar"><img src="<?php echo base_url(); ?>assets/img/users/user1.png" /></a> <strong class="chatter_name">Luke Peters</strong>Hello!</span> <span class="chatter_msg_item chatter_msg_item_user"> <a href="" class="chatter_avatar"><img src="<?php echo base_url(); ?>assets/img/users/user2.jpg" /></a> <strong class="chatter_name">Jack Sparrow</strong>Oh hello. Who is this?</span> <span class="chatter_msg_item chatter_msg_item_admin"> <a href="" class="chatter_avatar"><img src="<?php echo base_url(); ?>assets/img/users/user1.png" /></a> <strong class="chatter_name">Luke Peters</strong>My name is Luke. How can I help you today? :)</span> <span class="chatter_msg_item chatter_msg_item_user"> <a href="" class="chatter_avatar"><img src="<?php echo base_url(); ?>assets/img/users/user2.jpg" /></a> <strong class="chatter_name">Jack Sparrow</strong>Just saying hello!</span> <span class="chatter_msg_item chatter_msg_item_admin"> <a href="" class="chatter_avatar"><img src="<?php echo base_url(); ?>assets/img/users/user1.png" /></a> <strong class="chatter_name">Luke Peters</strong>Oh alright, Hello then Jack, you pirate, you.</span> <span class="chatter_msg_item chatter_msg_item_admin"> <a href="" class="chatter_avatar"><img src="<?php echo base_url(); ?>assets/img/users/user2.jpg" /></a> <strong class="chatter_name">Luke Peters</strong>Hello!</span> <span class="chatter_msg_item chatter_msg_item_user"> <a href="" class="chatter_avatar"><img src="<?php echo base_url(); ?>assets/img/users/user1.png" /></a> <strong class="chatter_name">Jack Sparrow</strong>Oh hello. Who is this?</span> <span class="chatter_msg_item chatter_msg_item_admin"> <a href="" class="chatter_avatar"><img src="<?php echo base_url(); ?>assets/img/users/user2.jpg" /></a> <strong class="chatter_name">Luke Peters</strong>My name is Luke. How can I help you today? :)</span> <span class="chatter_msg_item chatter_msg_item_user"> <a href="" class="chatter_avatar"><img src="<?php echo base_url(); ?>assets/img/users/user1.png" /></a> <strong class="chatter_name">Jack Sparrow</strong>Just saying hello!</span> <span class="chatter_msg_item chatter_msg_item_admin"> <a href="" class="chatter_avatar"><img src="<?php echo base_url(); ?>assets/img/users/user2.jpg" /></a> <strong class="chatter_name">Luke Peters</strong>Oh alright, Hello then Jack, you pirate, you.</span> </div>
