...
var $map_width	= "400px";	// The width of the map container. Any units (ie 'px') can be used. If no units are provided 'px' will be presumed
var $mapTypeControlPosition	= 'CENTRE';	// The position of the MapType control, eg. 'BOTTOM_RIGHT'
...
var $drawingControlPosition	= '';	// The position of the Drawing Manager control, eg. 'TOP_RIGHT'
...
$marker['zIndex'] = '99999';	// The zIndex of the marker. If two markers overlap, the marker with the higher zIndex will appear on top
