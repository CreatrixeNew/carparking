...
require_once 'BounceActivity.php';
require_once 'TrackingActivity.php';
require_once 'ClickActivity.php';
require_once 'ForwardActivity.php';
require_once 'OpenActivity.php';
require_once 'UnsubscribeActivity.php';
require_once 'SendActivity.php';
require_once 'TrackingSummary.php';
