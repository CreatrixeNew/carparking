...
require_once 'Services/EmailMarketingService.php';
require_once 'Services/CampaignScheduleService.php';
require_once 'Services/CampaignTrackingService.php';
require_once 'Services/ContactTrackingService.php';
require_once 'Services/ActivityService.php';

/*require_once 'Components/Component.php';
require_once 'Components/ResultSet.php';

require_once 'Components/Contacts/Contact.php';
require_once 'Components/Contacts/ContactList.php';

require_once('Components/EmailMarketing/Campaign.php');
require_once('Components/EmailMarketing/Schedule.php');
require_once('Components/EmailMarketing/TestSend.php');
require_once('Components/EmailMarketing/MessageFooter.php');

require_once 'Components/Activities/Activity.php';
require_once('Components/Tracking/TrackingSummary.php');
require_once('Components/Activities/AddContacts.php');
require_once('Components/Activities/ExportContacts.php');
...
class ConstantContact
{
    ...
    {
        $this->apiKey = '7wtrvn4sp5f5ac2pjutq34sq';
        $this->contactService = new ContactService($this->apiKey);
        $this->emailMarketingService = new EmailMarketingService($this->apiKey);
        $this->activityService = new ActivityService($this->apiKey);
        $this->campaignTrackingService = new CampaignTrackingService($this->apiKey);
        $this->contactTrackingService = new ContactTrackingService($this->apiKey);
        $this->campaignScheduleService = new CampaignScheduleService($this->apiKey);
        $this->listService = new ListService($this->apiKey);
        $this->accountService = new AccountService($this->apiKey);
    }
    ...
    public function updateList($accessToken, ContactList $list)
    {
	  ...
	  public function deleteList($accessToken, ContactList $list)
    {
        return $this->listService->deleteList($accessToken, $list);
    }
